...
- When working on a substantial feature, create a Markdown file in `/local/plans` with the necessary details, tasks, and progress notes, and keep it updated as work progresses.
